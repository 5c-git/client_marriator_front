...
} from "./postCreateOrderActivitySuccess.schema";

import { UnxpectedError } from "~/shared/unexpectedError/unexpectedError";

export const postCreateOrderActivityKeys = ["postCreateOrderActivity"];

export type postCreateOrderActivityPayload = {
  orderId: number;
...
export const postCreateOrderActivityMockResponse = http.post(
  `${import.meta.env.VITE_POST_CREATE_ORDER_ACTIVITY}`,
  async () => {
    await delay(2000);
