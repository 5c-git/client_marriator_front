...
export const postUpdateOrderActivitySuccessSchema = z.object({
  data: z.object({
    id: z.number(),
...
export type PostUpdateOrderActivitySuccess = z.infer<
  typeof postUpdateOrderActivitySuccessSchema
>;
