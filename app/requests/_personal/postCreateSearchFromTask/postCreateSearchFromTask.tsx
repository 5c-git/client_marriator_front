...
import {
  PostCreateSearchFromTaskSuccess,
  postCreateSearchFromTaskSuccessSchema,
} from "./postCreateSearchFromTaskSuccess.schema";

import { UnxpectedError } from "~/shared/unexpectedError/unexpectedError";

export const postCreateSearchFromTaskKeys = ["postCreateSearchFromTask"];

export const postCreateSearchFromTask = async (
  accessToken: string,
  taskId: string,
  taskActivityId: string,
): Promise<PostCreateSearchFromTaskSuccess> => {
  try {
    const url = new URL(import.meta.env.VITE_POST_CREATE_SEARCH_FROM_TASK);
    ...
    const parsed = postCreateSearchFromTaskSuccessSchema.safeParse(response);
    ...
    if (parsed.success) {
      ...
      throw new Response(
        `Данные запроса postCreateSearchFromTask не валидны схеме`,
      );
    }
...
// MOCKS
export const mockResponseSuccess: PostCreateSearchFromTaskSuccess = {
  data: {
    id: 3,
    user: {
      id: 397,
