...
export const mockResponseSuccess = {
  result: {
    userData: {
      ...
      updated_at: "2024-10-02T09:58:55.000000Z",
      api_token: null,
      phone: 79152142630,
      ...
      img: "http://preprod.marriator-api.fivecorners.ru/storage/source/userImg/2/pjfPzdEZMpI4bGbUVGjn.jpeg",
      confirmRegister: 1,
      pin: 1111,
      finishRegister: 1,
      expansionData:
      ...
      estateData: null,
      requisitesData:
        '{"1": {"bik": "sber1", "fio": "yastrebtsob andrew", "card": "5536913757516790", "account": "11111111111111111111", "cardDue": "2024-12-27", "confidant": true, "payWithCard": "yes"}, "-1": {"bik": "sber1", "fio": "TEST", "card": "5536913757516790", "account": "11111111111111111111", "cardDue": "2024-12-27", "confidant": true, "payWithCard": "yes"}}',
      mapAddress:
