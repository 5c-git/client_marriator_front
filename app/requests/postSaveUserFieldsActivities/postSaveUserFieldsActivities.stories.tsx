...
import schemaError from "./postSaveUserFieldsActivitiesError.schema.json";

const Mock = () => <></>;

const meta = {
  title: "Сетевые запросы/Внутренние/postSaveUserFieldsActivities",
  component: Mock,
  tags: ["autodocs"],
    ...
    docs: {
      page: () => (
        <>
          ...
          <h1>method: POST</h1>
          <h3>переменная: VITE_SAVE_USER_FIELDS_ACTIVITIES</h3>
          <h3>адрес: {import.meta.env.VITE_SAVE_USER_FIELDS_ACTIVITIES}</h3>
