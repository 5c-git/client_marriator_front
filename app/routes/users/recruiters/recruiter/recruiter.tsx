...
import { S_SwipeableDrawer } from "./recruiter.styled";
...
export default function Recruiter({ loaderData }: Route.ComponentProps) {
  const { t } = useTranslation("users_recruiter");
    ...
    <>
      ...
      >
        <TopNavigation
          ...
          backAction={() => {
            navigate(withLocale("/users/recruiters"), {
              viewTransition: true,
            });
          }}
        />
        ...
        >
          ...
          >
            ...
            <Button
              ...
              state={{
                from: `/users/recruiter/${loaderData.client.id}`,
                status: state.status,
