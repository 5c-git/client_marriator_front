...
export async function clientLoader({ params }: Route.ClientLoaderArgs) {
  ...
  if (accessToken) {
    ...
    return {
      ...
      taskActivity: params.activityId,
      activities,
      locations,
    };
  } else {
...
export async function clientAction({
  ...
  if (accessToken) {
    await postUpdateTaskActivity(accessToken, fields);
...
export default function EditService({ loaderData }: Route.ComponentProps) {
  ...
  const startingActivityValues = location.state
    .service as GetTaskSuccess["data"]["orderActivities"][0];
  ...
  const {
    ...
    defaultValues: {
      ...
      days: (() => {
        ...
        startingActivityValues.dateActivity.forEach((item) => {
  ...
  return (
    <>
      ...
      >
        {!editMode ? (
          <Avatar
            src={`${import.meta.env.VITE_ASSET_PATH}${startingActivityValues.viewActivity.logo}`}
        ...
        <form
          ...
          onSubmit={handleSubmit((values) => {
            const payload: postUpdateTaskActivityPayload = {
            ...
            render={({ field }) =>
              editMode ? (
                ...
                >
                  ...
                  >
                    {startingActivityValues.viewActivity.name}
                  </Typography>
                </Box>
              )
            }
        ...
        {editMode ? (
          ...
          >
            ...
            <Button form="edit-service-form" type="submit" variant="contained">
              {t("saveButton")}
            </Button>
          </Box>
        ) : null}
