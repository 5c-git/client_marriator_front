...
import type { GetOrderSuccess } from "~/requests/_personal/getOrder/getOrderSuccess.type";
...
export async function clientLoader({ params }: Route.ClientLoaderArgs) {
  ...
  if (accessToken) {
    ...
    return {
      ...
      orderActivity: params.activityId,
      activities,
      locations,
    };
  } else {
...
export default function EditService({ loaderData }: Route.ComponentProps) {
  ...
  const startingActivityValues = location.state
    .service as GetOrderSuccess["data"]["orderActivities"][0];
