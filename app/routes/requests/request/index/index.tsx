...
export default function Index({ loaderData }: Route.ComponentProps) {
  ...
  const { t } = useTranslation("request_index");
  ...
  const mockRequest = {
    ...
    radius: request.radius ? request.radius.toString() : "",
    ...
    // ],
    amount: request.count.toString(),
    taxStatus: request.selfEmployed ? t("selfEmployed") : t("notSelfEmployed"),
  ...
  return (
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  sx={(theme) => ({ color: theme.vars.palette["Black"] })}
                >
                  {watch("unitPrice") && mockRequest.selfEmployed
        ...
        >
          ...
          >
            ...
            <Box>
              ...
              >
                {mockRequest.responsiblePerson.email}
              </Typography>
              <Typography
                component="p"
                variant="Reg_12"
    ...
    //   </p>
    //   <p>
    //     запрос на получение локаций <b>getPlaceForBid</b>
    //   </p>
    //   <p>
    //     запрос радиуса для селекта <b>getRadiusSelect</b>
    //   </p>
    //   <p>
    //     запрос сохрания заявки <b>updateBid</b>
    //   </p>
    // </>
  );
}
