...
export const LocationCheckboxMultiple = forwardRef(
  (props: LocationCheckboxMultipleProps, ref) => {
        ...
        >
          {props.options.map((item) => (
            ...
            >
              ...
              <Divider
                sx={{
                  background: (theme) => theme.palette["Grey_3"],
                  marginTop: "8px",
                  marginBottom: "8px",
                }}
              />
...
LocationCheckboxMultiple.displayName = "LocationCheckboxMultiple";
