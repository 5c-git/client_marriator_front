...
export type StyledAutocompleteBicProps = {
  inputType: "bic";
  name: string;
  value: string;
  placeholder: string;
...
export const StyledAutocompleteBic = forwardRef(
  (props: StyledAutocompleteBicProps, ref) => {
...
StyledAutocompleteBic.displayName = "StyledAutocompleteBic";
